...
typedef enum rp_video_codec {
    ...
    RP_CODEC_WMV = 8, RP_CODEC_VVC = 9, RP_CODEC_VP8 = 10, RP_CODEC_REAL_VIDEO = 11
} rp_video_codec;
...
typedef enum rp_edition_kind {
    ...
    RP_EDITION_FESTIVAL = 47, RP_EDITION_MULTI_DISC = 48, RP_EDITION_ALTERNATE_CUT = 49,
    RP_EDITION_SHORTENED = 50, RP_EDITION_LEAKED = 51, RP_EDITION_COLORIZED = 52,
    RP_EDITION_FULLSCREEN = 53, RP_EDITION_STANDARD = 54, RP_EDITION_CREDITLESS = 55,
    RP_EDITION_RE_RECORDED = 56, RP_EDITION_COMMENTARY = 57, RP_EDITION_EXPLICIT = 58,
    RP_EDITION_REISSUE = 59, RP_EDITION_ORIGINAL_ASPECT_RATIO = 60,
    RP_EDITION_RESTORED = 61
} rp_edition_kind;
