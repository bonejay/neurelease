...
| [docs/ANIME.md](docs/ANIME.md) | The anime verdict, and seven anime names read by both parsers |
| [docs/LIVE_ACTION.md](docs/LIVE_ACTION.md) | Seven live-action names, in five languages, read by both parsers |
